...
public:
	...
	static ElementArray generateBoxIndexedArray2(
		float width = 1, float depth = 1, float height = 1,
		RGBA lineColor = { 1, 1, 1, 1 });
	static ElementArray generateBoxIndexedArray3(
		float width = 1, float depth = 1, float height = 1, float num1 = 1, float num2 = 2, float num3 = 1,
		RGBA lineColor = { 1, 1, 1, 1 });
};
