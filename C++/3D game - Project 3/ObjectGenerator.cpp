...
ElementArray ObjectGenerator::generateBoxIndexedArray(
	float width, float depth, float height, RGBA lineColor)
{
	float halfWidth = width / 14.0f;
	float halfDepth = width / 14.0f;
	float halfHeight = width / 1.0f;
...
ElementArray ObjectGenerator::generateBoxIndexedArray2(
	float width, float depth, float height, RGBA lineColor)
{
	float halfWidth = width / 1.6f;
	float halfDepth = width / 14.0f;
	float halfHeight = width / 14.0f;

	// 1 + (16 * (4 + 4)) = 65
	float* vertexData = new float[129];
	vertexData[0] = 128;
	int i = 1;
	// Positions
	// 0
	...
	halfWidth = width / 14.0f;
	halfDepth = width / 1.6f;
	halfHeight = width / 14.0f;
	// Positions
	// 8
	vertexData[i++] = -halfWidth;
	vertexData[i++] = halfHeight;
...
ElementArray ObjectGenerator::generateBoxIndexedArray3(
	float width, float depth, float height, float num1, float num2, float num3, RGBA lineColor)
{
	float halfWidth = width / num1;
	float halfDepth = width / num2;
	float halfHeight = width / num3;
