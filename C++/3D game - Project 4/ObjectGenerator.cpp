...
ElementArray ObjectGenerator::generateTexturedCuboid(int numberOfWidthSegments, int numberOfDepthSegments, float width, float depth, float height, RGBA faceColor)
{
