...
GhostObject::GhostObject(const string& name, float width, float depth, float height, RGBA faceColor) : BaseCuboid(name, width, depth, height, faceColor)
{
	this->generate();
}
