...
Ghost2::Ghost2(const string& name, OGL2DTexture* texture) : OGL3DCompositeObject(name)
{
	this->body = new GhostObject("body", 2, 0.15f, 1.0f, { 1,0.3f,0,1 });
	this->body2 = new GhostObject("body2", 1.6f, 0.15f, 1.5f, { 1,0.3f,0,1 });
	this->body3 = new GhostObject("body3", 1.3f, 0.15f, 1.5f, { 1,0.3f,0,1 });
	this->body4 = new GhostObject("body4", 1.0f, 0.15f, 1.5f, { 1,0.3f,0,1 });
	this->body5 = new GhostObject("body5", 0.6f, 0.15f, 1.1f, { 1,0.3f,0,1 });
	this->body6 = new GhostObject("body6", 0.3f, 0.15f, 1.1f, { 1,0.3f,0,1 });
...
void Ghost2::setShaderProgram(GLuint shaderProgram)
{
...
void Ghost2::update(float elapsedSeconds)
{
